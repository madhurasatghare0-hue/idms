...
//       {/* Two-column wrapper */}
//       <div className="w-full max-w-[820px] flex items-center justify-center gap-0">

//         {/* ── Login card ── */}
//         <div className="w-full max-w-[400px] bg-white rounded-[20px] overflow-hidden shadow-xl z-10">

//           {/* Top gradient strip */}
//           <div
//             className="h-1 w-full"
//             style={{ background: "linear-gradient(90deg, #EA580C, #FBBF24, #EA580C)" }}
//           />
...
//             {/* Heading */}
//             <h2 className="text-[22px] font-semibold text-center text-stone-800 mb-1">
//               {t("auth.login")}
//             </h2>
//             <p className="text-center text-[13px] text-stone-400 mb-6">
//               {t("auth.welcome")}
//             </p>
...
//                   <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-300" />
//                   <input
//                     type="text"
//                     placeholder={t("auth.enterUsername")}
//                     className="w-full bg-orange-50 border border-orange-100 rounded-xl pl-10 pr-3 py-2.5 text-sm text-stone-700 placeholder:text-stone-300 outline-none focus:border-orange-400 focus:bg-white transition-colors"
//                   />
//                 </div>
//               </div>
...
//                 </label>
//                 <div className="relative">
//                   <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-300" />
//                   <input
//                     type="password"
...
//   className="w-full text-white text-sm font-medium rounded-xl py-3 transition-opacity hover:opacity-95 active:scale-[0.98]"
//   style={{
...
//               <span className="text-[11px] text-stone-300">किंवा</span>
//               <div className="flex-1 h-px bg-orange-100" />
//             </div>
      ...
      <div className="relative w-full max-w-[820px] flex items-center justify-center gap-0 z-10">
        ...
        >
          ...
          <div className="px-8 pt-9 pb-7">
            ...
            <p className="text-center text-[13px] text-stone-400 mb-7">{t("auth.welcome")}</p>
                ...
                >
                  <User
                    ...
                    className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors ${
                      focusedField === "user" ? "text-orange-500" : "text-orange-300"
                    }`}
                  />
                  <input
                    type="text"
              ...
              <div>
                ...
                >
                  <Lock
                    size={16}
                    className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors ${
                      focusedField === "pass" ? "text-orange-500" : "text-orange-300"
                    }`}
                  />
                  <input
